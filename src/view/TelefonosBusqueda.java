...
public class TelefonosBusqueda extends javax.swing.JInternalFrame {

    public TelefonosBusqueda() {
        initComponents();
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(EDT_Apellido, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BTN_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTN_BuscarActionPerformed
        ...
        if (telefonos.size() > 0) {
            for (String telefono : telefonos) {
                TA_Clientes.setText(TA_Clientes.getText() + telefono + "\n");
            }
        }else {
            TA_Clientes.setText("No se encontraron telefonos para el apellido buscado \n");
        }
